...
namespace ClaimsModule.Infrastructure.Migrations
{
    ...
    [Migration("20250606182411_AddMissingFieldsToPolicyAndClaim")]
    partial class AddMissingFieldsToPolicyAndClaim
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClaimsModule.Domain.Entities.Claim", b =>
                {
                    ...
                    b.Property<string>("AreasDamaged")
                        .HasColumnType("longtext");
                    ...
                    b.Property<bool>("WasAnyoneInjured")
            ...
            modelBuilder.Entity("ClaimsModule.Domain.Entities.Policy", b =>
                {
                    ...
                    b.HasOne("ClaimsModule.Domain.Entities.PersistedDocument", "PolicyDocument")
                        .WithMany()
